<template>
  <div class="profile-container">
    <div class="profile-image">
      ...
      <img alt="image" src="/gray-vector.svg" class="profile-image1" />
    ...
    <div class="profile-container01">
      <div class="profile-container02">
        <div class="profile-container03">
          ...
          <app-counter type="Photos" number="10"></app-counter>
          <app-counter type="Comments" number="89"></app-counter>
        </div>
        <img alt="image" src="/team3-200h.jpg" class="profile-image2" />
        <div class="profile-container04">
          <div class="profile-container05">
            <primary-button button="connect"></primary-button>
          </div>
          <secondary-button button="message"></secondary-button>
        </div>
      </div>
