  ...
  <div class="home-container">
    <div class="home-hero">
      ...
      <div class="home-container01">
        <div class="home-container02">
          <h1 class="home-text">Your Day Start with us.</h1>
          <span class="home-text01">
            let&apos;s Create New Opportunity Every Day.
          </span>
        </div>
        <img alt="image" src="/gray-vector.svg" class="home-image" />
        <img alt="image" src="/white-vector.svg" class="home-image1" />
      </div>
    ...
    <div class="home-section1">
      <div class="home-container03">
        <div class="home-container04">
          <h3 class="home-text02 Healine">
            I&apos;ve risen with the soles burned
          </h3>
          <span class="home-text03 TextXL">
        ...
        <div class="home-cards-container">
          <div class="home-card1">
            ...
            <h6 class="home-text05 TextXL">Awarded Agency</h6>
          ...
          <div class="home-card2">
            <div class="home-container06">
              <svg viewBox="0 0 1097.142857142857 1024" class="home-icon02">
                <path
            ...
            <h6 class="home-text07 TextXL">Free Revisions</h6>
          ...
          <div class="home-card3">
            ...
            <h6 class="home-text09 TextXL">Verified Company</h6>
        ...
        <div class="home-work-with-us">
          <div class="home-container08">
            ...
            <h3 class="home-text11 Healine">Work with us is a pleasure</h3>
            <span class="home-text12">
              <span class="home-text13">
                Don&apos;t let your users guess by attaching tooltips and popoves
            ...
            <span class="home-text17">Check Notus PRO React!</span>
          </div>
          <div class="home-container10">
            <div class="home-container11">
              <img alt="image" src="/blue_wave.svg" class="home-image2" />
            </div>
            <div class="home-container12">
              <h4 class="home-text18 Healine">
                <span class="home-text19">Top Notch Services</span>
                <br />
              </h4>
      ...
      <img alt="image" src="/white-vector.svg" class="home-image3" />
    </div>
    <div class="home-section2">
      <div class="home-container13">
        <app-label text="WITH BURNED SOLES​"></app-label>
        <h2 class="home-text22 Text2XL">
          <span class="home-text23">
            You need to fight like David with Goliath
          </span>
          <br />
        </h2>
        <span class="home-text24 TextXL">
          Brother, life in est is not like in the west. Over the night, the black
          clouds appear, but at least I have my poetry for my freedom. The victory
          is for those that rise after they fall.
        </span>
      </div>
      <div class="home-growing-company-section">
        <img
          alt="image"
        ...
        <div class="home-container14">
          <div class="home-container15">
            <svg viewBox="0 0 967.4605714285714 1024" class="home-icon08">
              <path
          ...
          <h3 class="home-text25 Healine">A growing company</h3>
          <span class="home-text26">
            The extension comes with three pre-build pages to help you get started
          ...
          <div class="home-container16">
            ...
            <span class="home-text27">Carefully crafted components</span>
          </div>
          <div class="home-container18">
            ...
            <span class="home-text28">Amazing page examples</span>
          </div>
          <div class="home-container20">
            <div class="home-container21">
              <svg viewBox="0 0 1024.5851428571427 1024" class="home-icon15">
                <path
            ...
            <span class="home-text29">Dynamic components</span>
          </div>
        </div>
      </div>
      <div class="home-container22">
        <h6 class="home-text30"><span>THE ENTOURAGE</span></h6>
        <h3 class="home-text32 Healine">
          It is everything, and it won&apos;t change
        </h3>
        <span class="home-text33 TextXL">
          <span class="home-text34">
            It depends on your friends and companions, it depends on who goes out
            with you, if they have money, if you have money.
          </span>
        </span>
      </div>
      <div class="home-team">
        <div class="home-container23">
          <nuxt-link to="/profile" class="home-navlink">
            <div class="home-container24">
              <member-details imageSrc="/team1-200h.jpg"></member-details>
            ...
            <div class="home-container38">
              ...
              <div class="home-container39">
                ...
                <div class="home-container42">
                  <svg viewBox="0 0 1024 1024" class="home-icon37">
                    <path
                      d="M382 554h88v382q-62-6-139-43t-123-83q62-34 113-110t61-146zM730 554h206q-10 100-66 188-50-24-90-79t-50-109zM154 742q-58-90-66-188h206q-10 54-50 109t-90 79zM642 554q10 70 61 146t113 110q-44 46-121 83t-141 43v-382h88zM382 470q-10-70-61-146t-113-110q44-46 121-83t141-43v382h-88zM642 470h-88v-382q62 6 139 43t123 83q-62 34-113 110t-61 146zM294 470h-206q10-100 66-188 50 24 90 79t50 109zM730 470q10-54 50-109t90-79q56 88 66 188h-206z"
                    ></path>
                  </svg>
                ...
                <div class="home-container43">
                  <svg viewBox="0 0 877.7142857142857 1024" class="home-icon39">
                    <path
                      d="M585.143 512c0-80.571-65.714-146.286-146.286-146.286s-146.286 65.714-146.286 146.286 65.714 146.286 146.286 146.286 146.286-65.714 146.286-146.286zM664 512c0 124.571-100.571 225.143-225.143 225.143s-225.143-100.571-225.143-225.143 100.571-225.143 225.143-225.143 225.143 100.571 225.143 225.143zM725.714 277.714c0 29.143-23.429 52.571-52.571 52.571s-52.571-23.429-52.571-52.571 23.429-52.571 52.571-52.571 52.571 23.429 52.571 52.571zM438.857 152c-64 0-201.143-5.143-258.857 17.714-20 8-34.857 17.714-50.286 33.143s-25.143 30.286-33.143 50.286c-22.857 57.714-17.714 194.857-17.714 258.857s-5.143 201.143 17.714 258.857c8 20 17.714 34.857 33.143 50.286s30.286 25.143 50.286 33.143c57.714 22.857 194.857 17.714 258.857 17.714s201.143 5.143 258.857-17.714c20-8 34.857-17.714 50.286-33.143s25.143-30.286 33.143-50.286c22.857-57.714 17.714-194.857 17.714-258.857s5.143-201.143-17.714-258.857c-8-20-17.714-34.857-33.143-50.286s-30.286-25.143-50.286-33.143c-57.714-22.857-194.857-17.714-258.857-17.714zM877.714 512c0 60.571 0.571 120.571-2.857 181.143-3.429 70.286-19.429 132.571-70.857 184s-113.714 67.429-184 70.857c-60.571 3.429-120.571 2.857-181.143 2.857s-120.571 0.571-181.143-2.857c-70.286-3.429-132.571-19.429-184-70.857s-67.429-113.714-70.857-184c-3.429-60.571-2.857-120.571-2.857-181.143s-0.571-120.571 2.857-181.143c3.429-70.286 19.429-132.571 70.857-184s113.714-67.429 184-70.857c60.571-3.429 120.571-2.857 181.143-2.857s120.571-0.571 181.143 2.857c70.286 3.429 132.571 19.429 184 70.857s67.429 113.714 70.857 184c3.429 60.571 2.857 120.571 2.857 181.143z"
                    ></path>
                  </svg>
    ...
    <div class="home-section3">
      <div class="home-container44">
        <h6 class="home-text35 TextSM"><span>ON THE COASTLINE</span></h6>
        <h3 class="home-text37 Healine">We are missing the summer</h3>
        <span class="home-text38 TextXL">
        ...
        <div class="home-services">
          ...
          <div class="home-container45">
            <div class="home-container46">
              <svg viewBox="0 0 1024 1024" class="home-icon41">
                <path
            ...
            <h1 class="home-text40 TextXL">Grow your market</h1>
          ...
          <div class="home-container47">
            <div class="home-container48">
              <svg viewBox="0 0 1024 1024" class="home-icon43">
                <path
            ...
            <h1 class="home-text42 TextXL">Launch time</h1>
        ...
        <div class="home-contact">
          <app-label text="MESSAGE US"></app-label>
          <h2 class="home-text44">Type in the bellow form</h2>
          <span class="home-text45 TextXL">
            They say there&apos;s no future for the street rascals, nothing for
            them, leave them to fall. But it isn&apos;t always how you would like
            it to be, especially when you do nothing for yourself.
          </span>
          <div class="home-form">
            <h1 class="home-text46">Want to work with us?</h1>
            <span class="home-text47 TextXL">
              Complete this form and we will get back to you in 24 hours.
            </span>
            <span class="home-text48 TextXS">FULL NAME</span>
            <input
              type="text"
              placeholder="Full Name"
              class="home-textinput TextSM input"
            />
            <span class="home-text49 TextXS">EMAIL</span>
            <input
              type="text"
              placeholder="Email"
              class="home-textinput1 TextSM input"
            />
            <span class="home-text50 TextXS">MESSAGE</span>
            <textarea
              cols="80"
              rows="4"
              disabled="true"
              placeholder="Type a message"
              class="home-textarea TextSM textarea"
            ></textarea>
      ...
      <img alt="image" src="/gray-vector.svg" class="home-image5" />
    </div>
