        ...
        <div className="home-hero">
          ...
          <div className="home-container01">
            <div className="home-container02">
              <h1 className="home-text">Your Day Start with us.</h1>
        ...
        <div className="home-section1">
          <div className="home-container03">
            <div className="home-container04">
              <h3 className="home-text02 Healine">
            ...
            <div className="home-cards-container">
              <div className="home-card1">
                ...
                <h6 className="home-text05 TextXL">Awarded Agency</h6>
              ...
              <div className="home-card2">
                ...
                <h6 className="home-text07 TextXL">Free Revisions</h6>
              ...
              <div className="home-card3">
                ...
                <h6 className="home-text09 TextXL">Verified Company</h6>
            ...
            <div className="home-work-with-us">
              <div className="home-container08">
                ...
                <span className="home-text17">Check Notus PRO React!</span>
              </div>
              <div className="home-container10">
                ...
                <div className="home-container12">
                  <h4 className="home-text18 Healine">
                    <span className="home-text19">Top Notch Services</span>
                    <br></br>
                  </h4>
        ...
        <div className="home-section2">
          ...
          <div className="home-growing-company-section">
            ...
            <div className="home-container14">
              ...
              <h3 className="home-text25 Healine">A growing company</h3>
              ...
              <div className="home-container18">
                ...
                <span className="home-text28">Amazing page examples</span>
              </div>
              <div className="home-container20">
                ...
                <span className="home-text29">Dynamic components</span>
              </div>
            </div>
          </div>
              ...
              <Link href="/profile">
                <a className="home-link">
                  <div className="home-container24">
                    <MemberDetails imageSrc="/team1-200h.jpg"></MemberDetails>
